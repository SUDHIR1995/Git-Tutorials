...
public class JavaScriptExecutorConcept {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.findElement(By.name("username")).sendKeys("sudhir");
		...
		FileHandler.copy(src, new File("C:\\Users\\SUDHIR NITNAWARE\\Desktop\\selenium_file\\element.png"));
